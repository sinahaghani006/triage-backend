 ...
 * لیست ۱۴ دسته + متن دقیق برچسب‌های فارسی مستقیماً طبق پیام مستقیم
 * مدیرعامل (سینا)، ۱ آگوست ۲۰۲۶ گرفته شده و تغییر داده نشده. اما synonyms برای ۴
...
const FINAL_PRESENTING_PROBLEMS = [
  ...
  },
  {
    ...
    synonyms: ['کمردرد', 'درد مفاصل', 'بریدگی', 'کوفتگی', 'آسیب', 'گردن', 'ستون فقرات', 'نخاع', 'سردرد گردنی', 'درد زانو', 'زانودرد', 'زانو'],
  },
  {
    id: 'women_health',
