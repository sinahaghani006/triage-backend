 ...
 * ۱. محدودیت دارو/دوز/تشخیص قطعی که برای بیمار وجود داشت اینجا برداشته شده —
 *    چون مخاطب پزشک مجاز است، نه بیمار. output می‌تواند شامل توصیه‌ی درمانی/دارویی
 *    مشخص باشد.
...
- نام دارو، دوز پیشنهادی، و رویکرد درمانی مشخص ذکر کنی
...
۳. **پیشنهاد اقدام/درمان** (suggested_management): چون مخاطب پزشک
   مجاز است، می‌توانی اینجا مشخص‌تر باشی — شامل پیشنهاد دارو/دوز در
   صورت لزوم، آزمایش‌ها یا معاینات تکمیلی پیشنهادی، یا رویکرد درمانی.
   همیشه این را به‌عنوان «پیشنهاد برای بازبینی پزشک» قاب‌بندی کن، نه
   دستور قطعی — و اگر بیمار سابقه‌ی آلرژی یا تداخل دارویی مرتبط دارد
...

{
  ...
  "suggested_management": [
    "هر آیتم پیشنهاد اقدام/درمان/دارو، به‌صورت جمله‌ی مستقل و قابل‌کپی برای پزشک"
  ],
